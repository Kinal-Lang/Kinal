...
CJSON_DEFAULT_VERSION = "1.7.19"
CJSON_DEFAULT_TAG = "v1.7.19"
CJSON_DEFAULT_SOURCE_URL = "https://github.com/DaveGamble/cJSON"
CJSON_SRC_ARCHIVE_URL = "{source}/archive/refs/tags/{tag}.zip"
